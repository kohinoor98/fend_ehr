...
import 'package:fend_ehr/Screens/PatientEHRDetailScreen.dart';
import 'package:fend_ehr/WidgetComponents/MiniEHRCard.dart';
...
class PatientEHR extends StatefulWidget {
  @override
  _PatientEHRState createState() => _PatientEHRState();
}

class _PatientEHRState extends State<PatientEHR> {
