...
class EHRDetailScreen extends StatefulWidget {
  final EHR ehrData;
  const EHRDetailScreen({Key key, @required this.ehrData})
      : super(key: key);
  @override
  _EHRDetailScreenState createState() =>
      _EHRDetailScreenState();
}

class _EHRDetailScreenState extends State<EHRDetailScreen>
