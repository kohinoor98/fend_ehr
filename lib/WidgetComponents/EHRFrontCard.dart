...
class EHRFrontCard extends StatefulWidget {
  ...
  @override
  EHRFrontCardState createState() => EHRFrontCardState();
}

class EHRFrontCardState extends State<EHRFrontCard> {
